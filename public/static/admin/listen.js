...
define(['jquery', 'admin.plugins'], function () {
    ...
    this.$body.on('click', '[data-file]', function () {
        ...
        var url = window.ROOT_URL + '/index.php/admin/plugins/upfile.html?mode=' + method + '&uptype=' + uptype + '&type=' + type + '&field=' + field;
    ...
    this.$body.on('click', '[data-icon]', function () {
        ...
        var url = window.ROOT_URL + '/index.php/admin/plugins/icon.html?field=' + field;
